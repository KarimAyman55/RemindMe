...
class _LevelScreenState extends State<LevelScreen> {
  //level_select
  //final  _controller =  new CountdownController ();
  ...
  void initState(){
    ...
    first_index = widget.level_data.firstIndex;
    last_index_hor = widget.level_data.lastIndexHor;
    current_grid_size = widget.level_data.currentGridSize;
    current_selected_index = widget.level_data.firstIndex;
    input_cell = widget.level_data.inputCell;
  ...
  letterCell(context,{ int ?grid_size,dynamic index,int? selected_index}){
    Color border_color;
    ...
    return GestureDetector(
      onDoubleTap:(){
        setState((){
          is_hor=!is_hor;
          Fluttertoast.showToast( msg : is_hor?"HORIZONTAL":"VERTICAL", toastLength: Toast.LENGTH_SHORT,
                ...
                children: [
                  CircleButton(
                      onTap: (){
                        setState((){
                          is_hor = !is_hor;
                          Fluttertoast.showToast(msg :is_hor?"HORIZONTAL":"VERTICAL",
