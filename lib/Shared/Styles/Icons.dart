...
class IconBroken {
  ...
  static const IconData arrowDown_2 = IconData(0xe904, fontFamily: _fontFamily);
  static const IconData arrowDown_3 = IconData(0xe905, fontFamily: _fontFamily);
  static const IconData arrowDownCircle = IconData(0xe906, fontFamily: _fontFamily);
  static const IconData arrowDownSquare = IconData(0xe907, fontFamily: _fontFamily);
  ...
  static const IconData arrowLeft_3 = IconData(0xe90a, fontFamily: _fontFamily);
  static const IconData arrowLeftCircle = IconData(0xe90b, fontFamily: _fontFamily);
  static const IconData arrowLeftSquare = IconData(0xe90c, fontFamily: _fontFamily);
  static const IconData arrowLeft = IconData(0xe90d, fontFamily: _fontFamily);
  static const IconData arrowRight_2 = IconData(0xe90e, fontFamily: _fontFamily);
  static const IconData arrowRight_3 = IconData(0xe90f, fontFamily: _fontFamily);
  static const IconData arrowRightCircle = IconData(0xe910, fontFamily: _fontFamily);
  static const IconData arrowRightSquare = IconData(0xe911, fontFamily: _fontFamily);
  static const IconData arrowRight = IconData(0xe912, fontFamily: _fontFamily);
  static const IconData arrowUp2 = IconData(0xe913, fontFamily: _fontFamily);
  static const IconData arrowUp3 = IconData(0xe914, fontFamily: _fontFamily);
  static const IconData arrowUpCircle = IconData(0xe915, fontFamily: _fontFamily);
  static const IconData arrowUpSquare = IconData(0xe916, fontFamily: _fontFamily);
  ...
  static const IconData closeSquare = IconData(0xe925, fontFamily: _fontFamily);
  ...
  static const IconData paperDownload = IconData(0xe942, fontFamily: _fontFamily);
  static const IconData paperFail = IconData(0xe943, fontFamily: _fontFamily);
  static const IconData paperNegative = IconData(0xe944, fontFamily: _fontFamily);
  static const IconData paperPlus = IconData(0xe945, fontFamily: _fontFamily);
  static const IconData paperUpload = IconData(0xe946, fontFamily: _fontFamily);
